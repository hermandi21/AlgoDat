...
public class HashDictionary<K extends Comparable<K>,V> implements Dictionary<K,V>{
    ...
    /*
     * newCpacity ist Primzahl und gleichzeitig Hashtabellengröße, wenn bei einem LOADFACTOR > 2.0 
     * die Tabelle vergrößert werden muss und umgeschrieben werden muss.
     */
