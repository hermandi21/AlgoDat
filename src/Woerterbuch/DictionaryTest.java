...
public class DictionaryTest {
	...
	private static void testSortedArrayDictionary() {
		Woerterbuch.Dictionary<String, String> dict = new SortedArrayDictionary<>();
		testDict(dict);
	}
	
	private static void testHashDictionary() {
		Woerterbuch.Dictionary<String, String> dict = new HashDictionary<>(3);
		testDict(dict);
	}
	 ...
	 */
	private static void testDict(Woerterbuch.Dictionary<String, String> dict) {
